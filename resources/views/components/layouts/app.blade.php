...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="{{ route('home') }}">
				<img alt="Logo" style="width: 50px; height: 47px" src="/logo-small.png" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="index.html" class="brand-logo">
							<img alt="Logo" style="width: 190px; height: auto;" src="/logo-dark.png" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
											<div class="symbol-label" style="background-image:url('{{ Auth::user()->avatar->child('thumb')->url() }}')"></div>
					...
					<!--end::Header-->
					<!--begin::Content-->
					<div class="content mt-5 d-flex flex-column flex-column-fluid" id="kt_content">
						<!--begin::Entry-->
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="javascript:void(0);" target="_blank" class="text-dark-75 text-hover-primary">LBS</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
...
/* 			@if($errors->any())
			{!! implode('', $errors->all('
						<div class="alert border-0 alert-danger m-b-30 border-radius-none" role="alert">
							:message
						</div>
					')) !!}
			@endif */
