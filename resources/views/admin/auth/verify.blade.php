    ...
    <div class="d-flex flex-column-fluid flex-center">
        ...
        <div class="card card-custom bgi-no-repeat gutter-b" style="height: 250px; background-color: #1B283F; background-position: calc(100% + 0.5rem) calc(100% + 0.5rem); background-size: 100% auto; background-image: url(assets/media/svg/patterns/rhone-2.svg)">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="d-none" id="resend-form" method="POST" action="{{ route('admin.verification.resend') }}">
                    @csrf
                </form>
                ...
                <a  href="{{ route('admin.verification.resend') }}" onclick="event.preventDefault(); document.getElementById('resend-form').submit();" class="btn btn-link btn-link-warning font-weight-bold">{{ __('Click here to request another') }}
