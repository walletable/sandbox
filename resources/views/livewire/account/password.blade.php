<div>
    ...
    <div class="p-3">
        ...
        <form class="form" novalidate="novalidate"  wire:submit.prevent="start">
            ...
            <div class="pb-5" wire:ignore.self data-wizard-type="step-content" data-wizard-state="current">
                ...
                <div class="form-group">
                    <label class="font-size-h6 font-weight-bolder text-dark">Old Password</label>
                    <input type="password" wire:model="old_password" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6"  placeholder="Old Password" />
                </div>
                <!--end::Form Group-->
                <!--begin::Form Group-->
                <div class="form-group">
                    <label class="font-size-h6 font-weight-bolder text-dark">New Password</label>
                    <input type="password" wire:model="new_password" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6"  placeholder="New Password" />
                </div>
                <!--end::Form Group-->
                <!--begin::Form Group-->
                <div class="form-group">
                    <label class="font-size-h6 font-weight-bolder text-dark">Confirm Password</label>
                    <input type="password" wire:model="new_password_confirmation" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6"  placeholder="Confirm Password" />
                </div>
                <!--end::Form Group-->
            </div>
        ...
        @else
        <!--begin::Form-->
        <form class="form" novalidate="novalidate"  wire:submit.prevent="change">
            ...
            <div class="text-center">
                <button class="btn btn-primary font-weight-bolder font-size-h6 pl-5 pr-8 py-4 my-3" type="submit">
                        <span class="spinner spinner-right spinner-warning ml-7 mb-1"  wire:loading wire:target="change"></span>
                        Change
                    <span class="svg-icon svg-icon-md ml-2">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Right-2.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
